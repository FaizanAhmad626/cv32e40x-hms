################################################################################
# create_project_scu35.tcl
#
# Creates the Vivado project for CV32E40X on the SCU35 Evaluation Board.
# Vivado 2025.2.
#
...
set fpga_root    "$repo_root/fpga/scu35"
...
set wcfg_file    "$fpga_root/waveform_file/cv32e40x_wrapper_behav.wcfg"
...
# ------------------------------------------------------------------------
# 3. Clocking Wizard: 100 MHz in, 50 MHz out
#
